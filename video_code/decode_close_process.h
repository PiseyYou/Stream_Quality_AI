#ifndef DECODE_CLOSE_PROCESS_H
#define DECODE_CLOSE_PROCESS_H
...
bool is_close_thread = false;
bool is_release_encoder = false;
bool is_release_decoder = false;
context_de ctx;
int decode_proc(int dec_index,int width, int height,string url);
int decode_h264(unsigned char *h264_data,int frameSize,bool flag_close);
